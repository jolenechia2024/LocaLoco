...
businessRouter.post(
    ...
    businessController.getFilteredBusinesses.bind(businessController),
);

// triggered by a user clicking the View Details button, this route fetches a single business from the database
businessRouter.get(
    "/api/business",
    businessController.getBusinessByUEN.bind(businessController),
);

// search for a business by name (for forum tagging)
businessRouter.get(
    "/api/businesses/search",
    businessController.searchBusinessByName.bind(businessController),
);
...
businessRouter.post(
    ...
    businessController.getOwnedBusinesses.bind(businessController),
);
...
businessRouter.get(
    "/api/check-uen",
    businessController.checkUenAvailability.bind(businessController),
);
