...
class FeatureController {
    ...
    static async getBusinessReviews(
        ...
        try {
            const reviews = await ReviewModel.getBusinessReviews(
    ...
    static async updateReviewLikes(
        req: Request,
        res: Response,
        next: NextFunction,
    ): Promise<void> {
        try {
            ...
            const result = await ReviewModel.updateReviewLikes(
                reviewId,
                clicked,
            );
    ...
    static async getForumPostsByBusinessUEN(
        req: Request,
        res: Response,
        next: NextFunction,
    ): Promise<void> {
        try {
            ...
            const forumPosts =
                await ForumModel.getForumPostsByBusinessUEN(businessUen);
            res.status(200).json(forumPosts);
        } catch (error) {
            next(error);
        }
    ...
    static async newForumPostReply(
        req: Request,
        res: Response,
        next: NextFunction,
    ): Promise<void> {
    ...
    static async getAnnouncementsByUEN(
        req: Request,
        res: Response,
        next: NextFunction,
    ): Promise<void> {
        try {
            ...
            const announcements =
                await AnnouncementModel.getAnnouncementsByUEN(uen);
            res.status(200).json(announcements);
        } catch (error) {
            console.error(`Error adding announcement: ${error}`);
            next(error);
