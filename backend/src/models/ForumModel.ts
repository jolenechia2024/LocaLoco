...
class ForumModel {
    ...
    public static async getAllForumPosts(): Promise<ForumPost[]> {
        ...
        for (let post of posts) {
            ...
            for (const r of replies) {
                ...
                const replyUserResult = await db
                    .select({ image: user.image })
                    .from(user)
    ...
    public static async getForumPostsByBusinessUEN(
        businessUen: string,
    ): Promise<ForumPost[]> {
    ...
    public static async updatePostLikes(
        postId: number,
    ...
    public static async updateReplyLikes(
        replyId: number,
        clicked: boolean = false,
    ) {
    ...
    public static async newForumReply(
        reply: Omit<ForumPostReply, "id" | "createdAt" | "likeCount">,
    ) {
