          ...
          >
            ...
            >
              <div className="flex flex-col gap-2 text-sm">
                <div className="flex items-center gap-2">
                  <img src="http://maps.google.com/mapfiles/ms/icons/green-dot.png" alt="User Location" className="w-4 h-4" />
                  <span className={textMain}>Your location</span>
                </div>
                <div className="flex items-center gap-2">
                  <img src="http://maps.google.com/mapfiles/ms/icons/blue-dot.png" alt="Nearest Business" className="w-4 h-4" />
                  <span className={textMain}>Nearest businesses</span>
                </div>
                <div className="flex items-center gap-2">
                  <img src="http://maps.google.com/mapfiles/ms/icons/pink-dot.png" alt="Selected Business" className="w-4 h-4" />
            ...
            {userLocation && (
              <div style={{ position: 'absolute', top: '55px', right: '10px', zIndex: 10 }}>
                ...
                >
                  <img src="http://maps.google.com/mapfiles/ms/icons/green-dot.png" alt="My Location" className="w-6 h-6" />
                </button>
              </div>
            )}
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <Button
                        size="icon"
                        variant="outline"
                        className={`${borderTone} ${isDarkMode ? 'text-white hover:bg-neutral-800' : 'text-gray-900 hover:bg-gray-100'}`}
        ...
        <div className="max-w-none mx-auto h-full flex flex-col gap-3 px-4 pt-4 pb-4">
          ...
          <div className="flex-1 min-h-0 overflow-y-auto">
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              ...
              {filtered.length === 0 && <div className={`text-sm py-8 text-center ${textMuted}`}>No results.</div>}
            </div>
          </div>
        </div>
      </div>
