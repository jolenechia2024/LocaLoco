...
export function ProfilePageDisplay() {
    ...
    const handleViewBusinessDetails = (business: Business) =>
        navigate(`${ROUTES.BUSINESSES}/${business.uen}`);
    ...
    const handleAddBusiness = async (data: BusinessVerificationData) => {
        ...
        try {
            ...
            const response = await fetch(
                `${API_BASE_URL}/api/register-business`,
                {
                    method: "POST",
            ...
            toast.success("Business registered successfully! Refreshing...", {
                id: toastId,
            });
